...
with open('calibration_720/frameSize_720.pkl', 'rb') as f:
...
images = glob.glob('calibration_720/images/*.png')
...
pickle.dump((cameraMatrix, dist), open("calibration_720/calibration_720.pkl", "wb"))
pickle.dump(cameraMatrix, open("calibration_720/cameraMatrix_720.pkl", "wb"))
pickle.dump(dist, open("calibration_720/dist_720.pkl", "wb"))

# Save object points and image points
pickle.dump(objpoints, open("calibration_720/objpoints_720.pkl", "wb"))
pickle.dump(imgpoints, open("calibration_720/imgpoints_720.pkl", "wb"))

# Save rvecs and tvecs for reprojection error calculation
pickle.dump(rvecs, open("calibration_720/rvecs_720.pkl", "wb"))
pickle.dump(tvecs, open("calibration_720/tvecs_720.pkl", "wb"))
